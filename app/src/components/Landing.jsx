...
const useStyles = makeStyles((theme) => ({
  ...
  countdownCard: {
    ...
    backgroundImage:
      "linear-gradient(rgba(10, 10, 17, 0), rgba(10, 10, 17, 0)), linear-gradient(101deg, #6720B3, #A9209C)",
    ...
    <div className={classes.paper}>
      <div className={classes.innerContact}>
        <Typography align="center" variant="h4">
          {" "}
          Submit your Apple ID to request beta access today:
        </Typography>
  ...
  return (
    <Grid item container className={classes.landingSection} id="0">
      <Grid item container alignItems="center">
              ...
              <Grid item container direction="row" justify="center">
                <Grid item className={classes.buttonContainer}>
                  <Button
                    variant="outlined"
                    target="_blank"
                    href="https://apps.apple.com/us/app/aux-tunes/id1569550733"
                  >
                    Start Listening
                  </Button>
                </Grid>
        ...
        <Grid item md={6} show={showVideo}></Grid>
      </Grid>
